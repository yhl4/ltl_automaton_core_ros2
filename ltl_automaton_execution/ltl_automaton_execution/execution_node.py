...
class ExecutionManagerNode(Node):
    """Fetch matching snapshots and publish completed symbolic observations."""

    def __init__(self, *, backend=None, execution_delay_sec=None, **kwargs):
        ...
        selected_backend = backend or FakeBackend(self._schedule, delay)
